...
LEGAL_METROLOGY_RULES: Dict[str, RuleDefinition] = {
    ...
    "LM-006": RuleDefinition(
        ...
        currently_effective=True,
        future_effective_notes="GSR 128(E) and GSR 312(E) insert/substitute Rule 6(10A) requiring e-commerce entities selling imported products to provide searchable/sortable country-of-origin filters effective 1 July 2027. Parakh AI evaluates physical package label photos and does not evaluate e-commerce website UI/filter compliance.",
        last_verified="September 2026",
